...
class AnnotationsControllerTest < ActionController::TestCase
  ...
  test "should create annotation" do
    assert_difference('Annotation.count') do
      post :create, annotation: { recording_id: @annotation.recording_id, time: @annotation.time, value: @annotation.value }
    end
  ...
  test "should update annotation" do
    patch :update, id: @annotation, annotation: { recording_id: @annotation.recording_id, time: @annotation.time, value: @annotation.value }
    assert_redirected_to annotation_path(assigns(:annotation))
  end
