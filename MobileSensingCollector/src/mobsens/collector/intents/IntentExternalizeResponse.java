...
public class IntentExternalizeResponse
{
	public static final String ACTION = "mobsens.ACTION_EXTERNALIZE_RESPONSE";
	...
	public static void sendBroadcast(ContextWrapper contextWrapper, String handle, Date startTime, Date endTime, long transmitted, Throwable exception)
	{
